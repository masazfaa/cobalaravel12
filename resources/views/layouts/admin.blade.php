...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('assets/dashboard/src/assets/images/favicon.png') }}" />
</head>
            ...
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-start">
                ...
                <div>
                    <a class="navbar-brand brand-logo" href="{{ route('dashboard') }}">
                        <strong class="text-primary">WEBGIS ADMIN</strong>
                    </a>
                </div>
            </div>
            <div class="navbar-menu-wrapper d-flex align-items-top">
                <ul class="navbar-nav">
                    <li class="nav-item fw-semibold d-none d-lg-block ms-0">
                        ...
                        <h3 class="welcome-sub-text">Role Anda: <span class="badge {{ Auth::user()->role === 'superadmin' ? 'bg-danger' : 'bg-primary' }}">{{ ucfirst(Auth::user()->role) }}</span></h3>
                    </li>
                </ul>
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item dropdown d-none d-lg-block user-dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-right navbar-dropdown" aria-labelledby="UserDropdown">
                            ...
                            <a class="dropdown-item" href="{{ route('profile.edit') }}"><i class="dropdown-item-icon mdi mdi-account-outline text-primary me-2"></i> Profile Anda</a>
            ...
            <div class="main-panel">
                ...
                <footer class="footer">
                    <div class="d-sm-flex justify-content-center justify-content-sm-between">
                        <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">WebGIS Admin Dashboard</span>
